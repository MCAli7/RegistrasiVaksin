...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> {
    ...
    private ArrayList<InputDao> modelInputList = new ArrayList<>();
    ...
    public void setDataAdapter(ArrayList<InputDao> items) {
    ...
    public void onBindViewHolder(DataAdapter.ViewHolder holder, int position) {
        final InputDao data = modelInputList.get(position);
