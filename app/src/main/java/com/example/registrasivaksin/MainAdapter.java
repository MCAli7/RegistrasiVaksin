...
import com.example.registrasivaksin.ui.inputdata.InputDataActivity;
import com.example.registrasivaksin.utils.Constant;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    private List<com.example.registrasivaksin.ui.main.ModelMain> modelMainList;
    private Context mContext;

    public MainAdapter(Context context, List<com.example.registrasivaksin.ui.main.ModelMain> modelMain) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final com.example.registrasivaksin.ui.main.ModelMain data = modelMainList.get(position);
